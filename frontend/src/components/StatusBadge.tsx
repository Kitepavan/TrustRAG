...
const statusStyles: Record<string, { bg: string; text: string; dot: string }> = {
  ...
  trusted: { bg: 'bg-secondary-container/20', text: 'text-secondary', dot: 'bg-secondary' },
  suspicious: { bg: 'bg-tertiary-container/20', text: 'text-tertiary', dot: 'bg-tertiary' },
  quarantined: { bg: 'bg-error-container/20', text: 'text-error', dot: 'bg-error' },
